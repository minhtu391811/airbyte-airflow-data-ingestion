-- This script initializes a PostgreSQL database for an e-commerce application.
-- It creates tables for customers, products, orders, order items, and payments,
-- and populates them with sample data. It also sets up a user for Airbyte connector
...
ALTER TABLE films REPLICA IDENTITY DEFAULT;
ALTER TABLE film_category REPLICA IDENTITY DEFAULT;
ALTER TABLE actors REPLICA IDENTITY DEFAULT;
ALTER TABLE film_actors REPLICA IDENTITY DEFAULT;
ALTER TABLE users REPLICA IDENTITY DEFAULT;

-- Create publications for Airbyte to use
CREATE PUBLICATION airbyte_publication FOR TABLE films, film_category, actors, film_actors, users;
CREATE PUBLICATION airbyte_log_publication FOR TABLE films, film_category, actors, film_actors, users;
